            ...
            <div 
                ...
                <div className="large-homePageInnerTopOptionsContainer"
                        style={
                            {
                                ...
                                ...(homeFinancialScroll["fixed"] ? {"position": "fixed", "top": "51px"} : {})
                            }
                        }
                    >
                    <button className="large-homePageInnerTopOptionsBtn" 
                        ...
                        >
                        <span className="large-homePageInnerTopOptionsBtnDesc" style={{"color": "var(--primary-bg-01)"}}>
                            Data
                            <div className="large-homePageInnerTopOptionsBtnOutline"/>
                        </span>
                    </button>
                    <button className="large-homePageInnerTopOptionsBtn"
                            style={{"width": "calc((100% / 3) - 20px)", "minWidth": "calc((100% / 3) - 20px)", "maxWidth": "calc((100% / 3) - 20px)"}}
