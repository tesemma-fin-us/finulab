...
import {ChevronLeft, ChevronRight, ArrowDropUp, RadioButtonUnchecked, KeyboardBackspace, Whatshot, ExpandMore, Bookmark, Tsunami, Search, Cottage, AccountBalanceWallet, PersonSharp, AccountBalance, GroupAddSharp, Close, Verified, Newspaper, Apps, BookmarkAddSharp, PostAddSharp, AssuredWorkloadSharp, LogoutSharp, BookmarkAdded, SendSharp, ConnectWithoutContactSharp, Login, Send, Public, Notifications, BlurOn, CandlestickChart, ReadMore, Person, SearchSharp, DeveloperMode} from '@mui/icons-material';
    ...
    return(
        <div className="small-homePageWrapper">
            ...
            <div className="small-homePageContainer"
                ...
                {user ? 
                    <>
                        {!homeSearch && ((props.page === "profile" && props.displayView === "") || props.page === "home") ? 
                            ...
                            <>
                                {user.verified && !homeSearch && ((props.page === "profile" && props.displayView === "markets") || props.page === "market") && props.marketId === "" ? 
                                    <div className="large-secondaryhomePageContentCreateWrapper"
                                            style={
                                                {
                                                    ...{"right": `${sm_viewLeftbarWidth === 0 && sm_viewRightbarWidth === 0 ?
                ...
                <div className="large-homePageContentCreateWrapper" 
                        style={
                            {
                                ...
                                ...{
                                    "height": v_display ? "60px" : "0px",
                                    "minHeight": v_display ? "60px" : "0px",
                                    "maxHeight": v_display ? "60px" : "0px"
                                }
                            }
                        }
                    >
                    <div className="large-homePageContentCreateSecondaryWrapper">
                        ...
                        <button className="large-homePageMainNavigationIconContainerBtn"
                                onClick={() => homeSearchToggle()}
                                style={homeSearch ? {"marginTop": "0px", "backgroundColor": "var(--primary-bg-03)"} : {"marginTop": "0px"}}
                            >
                            <SearchSharp className="large-homePageMainNavigationIcon" 
                                style={homeSearch ? {"color": "var(--secondary-bg-03)"} : {}}
                            />
                            <span className="large-homePageMainNavigationIconContainerBtnDesc"
                                    style={homeSearch? {"color": "var(--secondary-bg-03)"} : {}}
                                >
