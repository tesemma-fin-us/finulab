...
export const StockChartContainer = (props) => {
	const now = new Date();
	...
	useEffect(() => {
		if(props.ticker !== undefined) {
			const widgetOptions = {
				...
				timeframe: "1M",//"1D", //{from: nowUnix - 86400, to: nowUnix}
				time_frames: [
					{ text: "1d", resolution: "5", description: "1 Day" },
					{ text: "5d", resolution: "30", description: "5 Days" },
					{ text: "1m", resolution: "90", description: "1 Month" },
					{ text: "3m", resolution: "120", description: "3 Month" },
					{ text: "1y", resolution: "1D", description: "1 Year" },
					{ text: "5y", resolution: "W", description: "5 Years" },
					//{ text: "All", resolution: "1W", description: "All", title: "All" },
				],
			};
			...
			tvWidget.onChartReady(async () => {
				...
				priceScale.setVisiblePriceRange({ "from": initialPriceRange.from * 0.90, "to": initialPriceRange.to * 1.05 });
